...
const templates = {
  ...
  handover: `<div class="file-breadcrumb">Campaigns <span>›</span> Winter Escapes 2027</div><div class="file-heading"><h1>Winter Escapes 2027</h1><p>A warmer way out.</p></div><div class="version-stage"><div class="version-column"><div class="eyebrow">SUPERSEDED</div><button id="brief-v1" class="brief-file" type="button"><span>Brief</span><strong>v1</strong><small>12 Sep 2026</small><em>Initial brief<br>and concepts.</em></button></div><div class="version-connection"><svg viewBox="0 0 260 90" aria-hidden="true"><path d="M4 51 C54 9 91 24 132 50 S218 75 251 42" fill="none" stroke="currentColor" stroke-width="2"/><path d="m239 35 12 7-6 13" fill="none" stroke="currentColor" stroke-width="2"/></svg><div>REFINED<br>AND APPROVED</div></div><div class="version-column"><div class="eyebrow approved-label">APPROVED</div><button id="brief-v2" class="brief-file" type="button"><span>Brief</span><strong>v2</strong><small>22 Sep 2026</small><em>Final brief<br>for production.</em></button></div></div><div class="file-actions"><button id="load-flawed" class="text-button" type="button">Open handed-over brief v1 ↗</button><div id="brief-preview" class="brief-preview"></div></div><div class="other-files"><h2>Other files</h2><button id="open-email-art" type="button">Approved email hero <span>↗</span></button><button id="open-reel-art" type="button">Partner Reel artwork <span>↗</span></button></div>`,
};
