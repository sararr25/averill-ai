...
] : [['Email Studio', () => window.desktop.openWork('email'), kind === 'email'], ['Social Publisher', () => window.desktop.openWork('social'), kind === 'social'], ['Campaign Files', () => window.desktop.openWork('handover')]];
