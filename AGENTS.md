...
Read `PROJECT.md`, `ARCHITECTURE.md`, and `travel-desktop/design-system/DESIGN_SYSTEM.md` before changing product behavior or UI.
...
- Describe current behavior accurately: structured changes arrive from three supplied Electron work windows after explicit sharing. Do not claim arbitrary desktop observation or external app control.
